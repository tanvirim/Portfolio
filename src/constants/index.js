...
export const projects = [
...

  {
    ...
    projectDescription:
      ' Admins, employees, and evaluators can register and access the app. Employees can conveniently update their progress using forms.Admins can analyze the data and provide valuable recommendations for promotions, increments, or both, based on the employees',
  ...
  },
  {
    ...
    projectDescription:
      "The Expense Management App simplifies expense tracking and management. It ensures data security with user authentication. Users can filter expenses by type and category. Visual representations offer insights through dynamic graphs. It's a valuable tool for personal or business finance management.",
